...
if __name__ == "__main__":
    ...
    if n_ifs == 4 and t_samp < 0.001 and n_int > 1024:
        ...
        if args.delete_fullstokes_fil:
         ...
         print("Skipping %s, not a fullstokes HTR product" % args.filename_in)
    t1 = time.time()
