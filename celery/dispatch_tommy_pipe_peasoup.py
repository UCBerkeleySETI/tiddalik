...
from tasks import  gather_filelists_recursive
from gpu_tasks import dispatch_to_node, run_tommy_pipe_peasoup

def dispatch_run_tommy_pipe_peasoup(path_to_files, file_ext):
    ...
    for node, filelist in file_dict.items():
        ...
        if filelist is not None:
            ...
            for filename in filelist:
                ...
                d = dispatch_to_node(run_tommy_pipe_peasoup, node, args=[filename,])
                d_out.append(d)
        else:
...
if __name__ == "__main__":
    ...
    dispatch_run_tommy_pipe_peasoup(args.path_to_files, args.extension)
